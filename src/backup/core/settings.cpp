...
void Settings::save(QString name, QString data)
{
    ...
    QSettings settings("/var/lib/harbour-dolphin/config/config.conf", QSettings::IniFormat);
...
void Settings::backup()
{
    ...
    shell.startDetached("/bin/cp", QStringList() << "-rf" << "/usr/share/harbour-dolphin/database/dp-hk.sqlite" << "/home/nemo/Dolphin/dp-hk.sqlite");
    qDebug() << shell.errorString();
...
{
    QProcess shell;
    shell.startDetached("/bin/cp", QStringList() << "-rf" << "/home/nemo/Dolphin/dp-hk.sqlite" << "/usr/share/harbour-dolphin/dp-hk.sqlite");
    qDebug() << shell.errorString();
}
