...
KeyBase {
    ...
    Item {
        ...
        Text {
            ...
            font.pixelSize: keyboard.inSymView? Theme.fontSizeLarge * config.scale: Theme.fontSizeTiny * config.scale
        ...
        Text {
            ...
            font.family: Theme.fontFamily
            lineHeight: 0.64
            font.pixelSize: keyboard.inSymView? Theme.fontSizeTiny * config.scale: ( secondaryLabel.text.length ===4? Theme.fontSizeMedium * config.scale: Theme.fontSizeMedium * config.scale )
            color: pressed ? Theme.highlightColor : Theme.primaryColor
